...
3. **Grupos `{...}`:** Todo lo que va entre llaves es un grupo o tradición que sostiene la postura, tal como lo define el documento fuente. No hay un campo de notas aparte.
