...
(function (global) {
  ...
  var UI = {
    es: {
      ...
      quizModoSeleccion: 'Elegir pregunta antes',
      quizModoSeleccionTitle: 'Con muchas ramas abiertas, primero eliges cuál responder y luego ves su ficha completa.',
      quizAvisoMuchasRamas: 'Hay {n} ramas abiertas. Si se vuelve abrumador, activa «Elegir pregunta antes» arriba.',
    ...
    en: {
      ...
      quizModoSeleccion: 'Pick question first',
      quizModoSeleccionTitle: 'With many open branches, you first choose which one to answer and then see its full card.',
      quizAvisoMuchasRamas: 'There are {n} open branches. If it feels crowded, turn on “Pick question first” above.',
