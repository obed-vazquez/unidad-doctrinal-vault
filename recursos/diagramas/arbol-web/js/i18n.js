...
(function (global) {
  ...
  var UI = {
    es: {
      ...
      recorrido: 'Recorrido',
      recorridoTitle: 'Cómo se revelan las ramas (A para ciclar; Ctrl+← / Ctrl+→ en pantallas anchas)',
      recorridoAria: 'Modo de recorrido',
      ...
      reiniciarTitle: 'Borrar respuestas, resaltados, anclajes y cambios locales del árbol',
      reiniciarTitulo: 'Reiniciar el árbol',
      reiniciarTexto: 'Se van a borrar <b>todos los cambios y personalizaciones</b> que hayas hecho a mano en el árbol '
        + '(nombres, preguntas, ramas, tamaños y posiciones), además de <b>{respuestas}</b>, '
        + '<b>{resaltados}</b> y <b>{anclajes}</b> del recorrido. También se olvidan en este navegador. '
        + 'El tema y el documento canónico no se tocan.',
      reiniciarAceptar: 'Borrar todo',
      nRespuesta: '{n} respuesta',
      nRespuestas: '{n} respuestas',
      nResaltado: '{n} resaltado',
      nResaltados: '{n} resaltados',
      nAnclaje: '{n} anclaje',
      nAnclajes: '{n} anclajes',
      ...
      buscarPlaceholder: 'Buscar tradición, postura o pregunta…',
      modoCompacto: 'Modo compacto',
      limpiarSeleccion: 'Limpiar selección',
      religionesInertes: 'En el cuestionario las tradiciones quedan en pausa: '
        + 'su recorrido termina en una postura concreta y mezclarlo con el tuyo '
        + 'te plantearía preguntas de ramas opuestas.',
      explorarPostura: 'Explorar',
      explorarTodas: 'Explorar todas',
      irComparar: 'Comparar →',
      irAnalizar: 'Analizar →',
      ...
      nodosDebajo: 'El número de la tarjeta son {n} nodos que cuelgan debajo.',
      nodosDebajoUno: 'El número de la tarjeta es 1 nodo que cuelga debajo.',
      nodosDebajoCero: 'Ningún nodo cuelga debajo: es una hoja del árbol.',
      ramaAbre: 'Abre {n} nodos del árbol.',
      ramaAbreUno: 'Abre 1 nodo del árbol.',
      quizProgreso: 'Pregunta {actual} · {respondidas} respondidas',
      quizDesde: 'Desde',
      quizAnalisis: 'Análisis de la pregunta',
      quizAnalisisVacio: 'Todavía no hay un análisis profundo vinculado a esta pregunta.',
      quizAnalisisAbrir: 'Abrir nota de análisis',
      quizAclaraciones: 'Aclaraciones',
      quizAclaracionesVacio: 'No hay notas de aclaración vinculadas a estas posturas.',
      quizAclaracionAbrir: 'Abrir nota',
      mdCargando: 'Cargando nota…',
      mdError: 'No se pudo cargar esta nota. Prueba el enlace externo.',
      mdVacio: 'No hay contenido en esta nota.',
      mdDocumento: 'Documento',
      mdDocumentos: 'Documentos relacionados',
      mdExpandir: 'Nota',
      quizRespuestas: 'Elige una respuesta',
      quizTradicionesSi: 'Tradiciones que suelen tomar este camino',
      quizPosturaDestino: 'Lleva a',
      quizSinTradicion: 'Sin tradición registrada en el documento',
      quizAtras: 'Anterior',
      quizSaltarArbol: 'Ver en el árbol',
      quizReiniciar: 'Empezar de nuevo',
      quizContinuar: 'Continuar',
      quizVerReporte: 'Ver mi recorrido',
      quizReporteTitulo: 'Tu mapa de posturas',
      quizReporteIntro: 'Según tus respuestas, estas son las posturas con las que más te identificas.',
      quizPosturasEspecificas: 'Posturas más específicas alcanzadas',
      quizSinPosturaNombrada: 'Ninguna postura con nombre en este recorrido.',
      quizPosturasCamino: 'Posturas que están alineadas con tus creencias',
      quizRelacion: 'Cómo llegaste aquí',
      quizRelacionDesde: 'Desciende de «{postura}».',
      quizRelacionRespuesta: 'Respondiste «{respuesta}» a: {pregunta}',
      quizRelacionPregunta: 'Vinculada a la pregunta: {pregunta}',
      quizTerminoSugerido: 'término sugerido',
      quizDenominacionDuda: 'denominación en duda',
      quizPasoCamino: 'Paso {n} del recorrido',
      quizReligionesEncaje: 'Tradiciones que encajan con tu postura',
      quizReligionesCercanas: 'Tradiciones cercanas',
      quizCoincidencias: 'Coincidencias en el camino',
      quizSinReligion: 'Ninguna tradición del documento sostiene exactamente esta postura.',
      quizExplorarArbol: 'Explorar en modo Indagatorio',
      quizExplorarPostura: 'Explorar esta postura en el árbol',
      quizExplorarTradicion: 'Explorar en el árbol',
      quizOtraVez: 'Repetir cuestionario',
      quizPaso: 'Paso {n}',
      quizDefinicion: 'Contexto',
      quizPesoRama: 'Abre {n} nodos más adelante',
      quizPesoRamaRotulo: 'Alcance',
      quizRevelar: 'Mostrar adelantos',
      quizRevelarTitle: 'Revela posturas, tradiciones y cuántos nodos abre cada respuesta. Por defecto está oculto para no anticipar el recorrido.',
      quizVariasRamas: 'Varias ramas abiertas',
      quizEligeRama: '¿Qué pregunta quieres responder ahora?',
      quizEligeRamaNota: 'Hay más de un eje abierto. Elige uno para continuar; los demás seguirán esperando hasta que llegues a sus hojas.',
      quizRamasAbiertas: '{n} ramas abiertas',
      quizRamaN: 'Rama {n}',
      quizRamaAbierta: 'Rama abierta',
      quizCambiarRama: 'Cambiar de rama',
      quizModoSeleccion: 'Modo simplificado',
      quizModoSeleccionTitle: 'Muestra una sola pregunta a la vez y avanza a la siguiente al responder.',
      quizAvisoMuchasRamas: 'Hay {n} ramas abiertas. Si se vuelve abrumador, activa «Modo simplificado» arriba.',
      quizPromptSimplificadaTitulo: 'Modo simplificado',
      quizPromptSimplificadaNota: 'Te mostraremos una pregunta a la vez. Si prefieres, también puedes ver todas las preguntas a la vez.',
      quizPromptSimplificadaSi: 'Ver una a la vez',
      quizPromptSimplificadaNo: 'Ver todas las preguntas a la vez',
      quizSinRespuesta: 'No responder',
      quizSinRespuestaNota: 'Cierra esta línea de cuestionamientos aquí y continúa con otras líneas, en caso de que tengas más de una pregunta abierta.',
      volverTitle: 'Volver a la vista anterior',
      volverAria: 'Volver a la vista anterior',
      ...
      expandirRamas: 'Expandir',
      colapsarRamas: 'Colapsar',
      expandirRamasTodo: 'Expandir todo',
      colapsarRamasTodo: 'Colapsar todo',
      ...
      ramasTodoDesc: 'Muestra u oculta todo el subárbol de esta tarjeta de una vez.',
      ...
      huerfanoTexto: '«{nombre}» quedaría sin padre. ¿Qué quieres hacer?',
      huerfanoAceptar: 'Eliminar',
      huerfanoEliminar: 'Eliminar',
      huerfanoAsignar: 'Asignar padre',
      padreInvalido: 'Ese nodo no puede ser el padre.',
      convergenciaInvalida: 'Esa unión no es válida: revisa el tipo de tarjeta, un ciclo o una postura que ya es origen.',
      sumarOrigen: 'Sumar postura de origen',
      sumarOrigenDesc: 'Une esta pregunta a otra postura de origen: se vuelve compartida.',
      convergerPregunta: 'Converger con pregunta existente',
      convergerPreguntaDesc: 'Une esta postura, como origen adicional, a una pregunta que ya existe.',
      quitarUnion: 'Quitar unión',
      quitarUnionDesc: 'Quita esta postura como origen de la pregunta. Las demás uniones quedan intactas.',
      posturaConvergente: 'Pregunta compartida',
      posturaConvergenteDesc: 'Uno de los ejes de esta postura lleva a una pregunta que también origina otra(s) postura(s).',
    ...
    en: {
      ...
      recorrido: 'Traversal',
      recorridoTitle: 'How branches are revealed (A to cycle; Ctrl+← / Ctrl+→ on wide screens)',
      recorridoAria: 'Traversal mode',
      ...
      reiniciarTitle: 'Clear answers, highlights, pins and local tree edits',
      reiniciarTitulo: 'Reset the tree',
      reiniciarTexto: 'This will delete <b>all changes and customizations</b> you made by hand to the tree '
        + '(names, questions, branches, sizes and positions), plus <b>{respuestas}</b>, '
        + '<b>{resaltados}</b> and <b>{anclajes}</b> from this traversal. They are also forgotten in this browser. '
        + 'The theme and the canonical document are left untouched.',
      reiniciarAceptar: 'Delete everything',
      nRespuesta: '{n} answer',
      nRespuestas: '{n} answers',
      nResaltado: '{n} highlight',
      nResaltados: '{n} highlights',
      nAnclaje: '{n} pin',
      nAnclajes: '{n} pins',
      ...
      buscarPlaceholder: 'Search tradition, posture or question…',
      modoCompacto: 'Compact mode',
      limpiarSeleccion: 'Clear selection',
      religionesInertes: 'Traditions pause inside the questionnaire: each one '
        + 'ends at a single posture, and mixing that with your own path would '
        + 'ask you questions from opposite branches.',
      explorarPostura: 'Explore',
      explorarTodas: 'Explore all',
      irComparar: 'Compare →',
      irAnalizar: 'Analyze →',
      ...
      nodosDebajo: 'The number on the card is {n} nodes hanging below.',
      nodosDebajoUno: 'The number on the card is 1 node hanging below.',
      nodosDebajoCero: 'No nodes hang below: it is a leaf of the tree.',
      ramaAbre: 'Opens {n} nodes of the tree.',
      ramaAbreUno: 'Opens 1 node of the tree.',
      quizProgreso: 'Question {actual} · {respondidas} answered',
      quizDesde: 'From',
      quizAnalisis: 'Question analysis',
      quizAnalisisVacio: 'There is no deep analysis linked to this question yet.',
      quizAnalisisAbrir: 'Open analysis note',
      quizAclaraciones: 'Clarifications',
      quizAclaracionesVacio: 'There are no clarification notes linked to these postures.',
      quizAclaracionAbrir: 'Open note',
      mdCargando: 'Loading note…',
      mdError: 'Could not load this note. Try the external link.',
      mdVacio: 'This note has no content.',
      mdDocumento: 'Document',
      mdDocumentos: 'Related documents',
      mdExpandir: 'Note',
      quizRespuestas: 'Choose one answer',
      quizTradicionesSi: 'Traditions that often take this path',
      quizPosturaDestino: 'Leads to',
      quizSinTradicion: 'No tradition recorded in the document',
      quizAtras: 'Previous',
      quizSaltarArbol: 'View in the tree',
      quizReiniciar: 'Start over',
      quizContinuar: 'Continue',
      quizVerReporte: 'See my path',
      quizReporteTitulo: 'Your map of postures',
      quizReporteIntro: 'Based on your answers, these are the postures you most identify with.',
      quizPosturasEspecificas: 'Most specific postures reached',
      quizSinPosturaNombrada: 'No named posture on this path.',
      quizPosturasCamino: 'Postures aligned with your beliefs',
      quizRelacion: 'How you got here',
      quizRelacionDesde: 'Descends from “{postura}”.',
      quizRelacionRespuesta: 'You answered “{respuesta}” to: {pregunta}',
      quizRelacionPregunta: 'Linked to the question: {pregunta}',
      quizTerminoSugerido: 'suggested term',
      quizDenominacionDuda: 'uncertain label',
      quizPasoCamino: 'Step {n} of the path',
      quizReligionesEncaje: 'Traditions that match your posture',
      quizReligionesCercanas: 'Nearby traditions',
      quizCoincidencias: 'Shared answers along the path',
      quizSinReligion: 'No tradition in the document holds this posture exactly.',
      quizExplorarArbol: 'Explore in Inquiry mode',
      quizExplorarPostura: 'Explore this posture in the tree',
      quizExplorarTradicion: 'Explore in the tree',
      quizOtraVez: 'Retake questionnaire',
      quizPaso: 'Step {n}',
      quizDefinicion: 'Context',
      quizPesoRama: 'Opens {n} nodes ahead',
      quizPesoRamaRotulo: 'Reach',
      quizRevelar: 'Show upcoming details',
      quizRevelarTitle: 'Reveals postures, traditions and how many nodes each answer opens. Off by default so the path is not spoiled.',
      quizVariasRamas: 'Several open branches',
      quizEligeRama: 'Which question do you want to answer now?',
      quizEligeRamaNota: 'More than one axis is open. Pick one to continue; the others will wait until you reach their leaves.',
      quizRamasAbiertas: '{n} open branches',
      quizRamaN: 'Branch {n}',
      quizRamaAbierta: 'Open branch',
      quizCambiarRama: 'Switch branch',
      quizModoSeleccion: 'Simplified mode',
      quizModoSeleccionTitle: 'Shows one question at a time and moves to the next after you answer.',
      quizAvisoMuchasRamas: 'There are {n} open branches. If it feels crowded, turn on “Simplified mode” above.',
      quizPromptSimplificadaTitulo: 'Simplified mode',
      quizPromptSimplificadaNota: 'We will show one question at a time. Or you can view all questions at once.',
      quizPromptSimplificadaSi: 'One at a time',
      quizPromptSimplificadaNo: 'View all questions at once',
      quizSinRespuesta: 'Don\'t answer',
      quizSinRespuestaNota: 'Close this line of questioning here and continue with other lines, if you have more than one question open.',
      volverTitle: 'Back to previous view',
      volverAria: 'Back to previous view',
      ...
      expandirRamas: 'Expand',
      colapsarRamas: 'Collapse',
      expandirRamasTodo: 'Expand all',
      colapsarRamasTodo: 'Collapse all',
      ...
      ramasTodoDesc: 'Shows or hides this card’s whole subtree at once.',
      ...
      huerfanoTexto: '“{nombre}” would be left without a parent. What do you want to do?',
      huerfanoAceptar: 'Delete',
      huerfanoEliminar: 'Delete',
      huerfanoAsignar: 'Assign parent',
      padreInvalido: 'That node cannot be the parent.',
      convergenciaInvalida: 'That union is not valid: check the card type, a cycle, or a posture that is already an origin.',
      sumarOrigen: 'Add origin posture',
      sumarOrigenDesc: 'Joins this question to another origin posture: it becomes shared.',
      convergerPregunta: 'Converge with existing question',
      convergerPreguntaDesc: 'Joins this posture, as an additional origin, to a question that already exists.',
      quitarUnion: 'Remove union',
      quitarUnionDesc: 'Removes this posture as an origin of the question. The other unions stay intact.',
      posturaConvergente: 'Shared question',
      posturaConvergenteDesc: 'One of this posture’s axes leads to a question that also originates from other posture(s).',
  ...
  function leerCacheDisco() {
    ...
    var correcciones = {
      '¿Jesús es Dios?': 'Is Jesus God?',
      'Canon neotestamentario pleno*': 'Full New Testament Canon*',
      'Canon neotestamentario restringido*': 'Restricted New Testament Canon*',
      'Carismáticos': 'Charismatics',
      'Depravación Total del hombre': 'Total Depravity of Man',
      'Postura del Lunático': 'Lunatic Posture',
      'Miticismo': 'Mythicism',
      'Sin-nombre': 'Unnamed',
      'Modalismo / Unicitarismo / Unicitarianismo': 'Modalism / Oneness / Unitarianism'
    };
    Object.keys(correcciones).forEach(function (clave) {
      if (cacheTrad[clave] && cacheTrad[clave] !== correcciones[clave]) {
        cacheTrad[clave] = correcciones[clave];
        hubo = true;
      }
    });
    if (hubo) guardarCacheDisco();
  }
